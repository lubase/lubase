...
public class AppConfig {
    ...
    public AppConfig withEnabled(Boolean enabled) {
        setEnabled(enabled);
        return this;
    }

    public AppConfig withVersion(String version) {
        setVersion(version);
        return this;
    }

    public AppConfig withProperties(Map<String, Object> properties) {
        setProperties(properties);
        return this;
    }

    public AppConfig withOverridePackages(List<String> overridePackages) {
